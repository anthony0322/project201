...
<div id="circ">
  <ul>
    ...
    <li class="animated zoomIn delayfive">
      <div class="back"></div>
      <div class="icon">
        <a href="https://mail.google.com/mail/u/0/?view=cm&fs=1&to=project201.cca@gmail.com&su=&body=&tf=1" style="color: rgb(14,1,36)" target="_blank"><i class="fa fa-google-plus"></i></a>
      </div>
    </li>
  </ul>
